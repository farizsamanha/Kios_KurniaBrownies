...
$pdf->Image('../logo/1.png',1,1,2,2);
$pdf->SetX(4);            
$pdf->MultiCell(19.5,0.5,'Kurnia Brownies',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'Telpon : (0271) 733179',0,'L');    
$pdf->SetFont('Arial','B',10);
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'Jl. Dr. Rajiman, Sondakan, Surakarta, Kota Surakarta, Jawa Tengah 57147',0,'L');
$pdf->SetX(4);
// $pdf->MultiCell(19.5,0.5,'Email : malasngoding@gmail.com',0,'L');
