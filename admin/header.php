...
<body>
	<div class="navbar navbar-default">
		<div class="container-fluid">
			<div class="navbar-header">
				<a href="http://www.malasngoding.com" class="navbar-brand">Kurnia Brownies</a>
			...
			<div class="collapse navbar-collapse">				
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a class="dropdown-toggle" data-toggle="dropdown" role="button" href="#">Hai , <?php echo $_SESSION['uname']  ?>&nbsp&nbsp<span class="glyphicon glyphicon-user"></span></a></li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div class="col-md-2">
		...
		<ul class="nav nav-pills nav-stacked">
			<li class=""><a href="index.php"><span class="glyphicon glyphicon-home"></span>  Dashboard</a></li>			
